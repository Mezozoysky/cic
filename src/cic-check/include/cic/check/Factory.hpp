...
public:
    ...
    FactoryMarker& operator=( const FactoryMarker& ) = delete;
};
...
public:
    ...
    {
        static_assert( std::is_default_constructible< ReqT >::value, "ReqT should have default constructor" );

        static_assert( std::is_base_of< AbstractionT, ReqT >::value, "ReqT should extend AbstractionT" );
    ...
    {
        static_assert( std::is_default_constructible< RegT >::value, "RegT should have default constructor" );

        static_assert( std::is_base_of< AbstractionT, RegT >::value, "RegT should extend AbstractionT" );
...
private:
    std::unordered_map< Id, Creator > mMap;
};
